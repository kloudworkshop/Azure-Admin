...
This lab requires an Azure subscription. Your subscription type may affect the availability of features in this lab. You may change the region, but the steps are written using UK West.
...
1. On the blade displaying the production slot of the web app, in the **App Service plan** section, click **Scale out**.
